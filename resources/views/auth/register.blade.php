      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('register') }}">
            ...
            <div class="row mb-3">
              <label for="nick" class="col-md-4 col-form-label text-md-end">{{ __('Nombre de usuario') }}</label>
              <div class="col-md-6">
            ...
            <div class="row mb-3">
              <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('Confirmar contraseña')
                }}</label>
              <div class="col-md-6">
